  ...
  return (
    <main className="auth-layout min-h-screen bg-[#f3f4f6] px-4 py-8 text-slate-700 sm:py-12">
      <div className="mx-auto w-full max-w-[448px]">
        ...
        >
          <label className="space-y-2 text-base font-semibold text-slate-700 sm:text-xl" htmlFor="signup-name">
            Nome
            ...
            {nameError ? (
              <span className="t-error-msg mt-1 block text-sm text-red-600 sm:text-base">{nameError}</span>
            ) : null}
          </label>
          <label className="space-y-2 text-base font-semibold text-slate-700 sm:text-xl" htmlFor="signup-email">
            E-mail
          ...
          >
            ...
            {passwordError ? (
              <span className="t-error-msg mt-1 block text-sm text-red-600 sm:text-base">{passwordError}</span>
            ) : null}
          </label>
